...
_Reset	.ivec _RESET_K,USE_RETA		; 0: RESET (Software 0: SINT0)				; Reset (hardware and software)
			...
			.ivec EXINT0_ISR			; 2: INT0 (Software 2: SINT2)				; External interrupt #0
...
DMAINT1		.ivec ISRDMA1				; 9: DMAC1 (Software 9: SINT9)				; DMA Channel #1 interrupt
...
DMAINT0		.ivec ISRDMA0				; 18: DMAC0 (Software 18: SINT18)			; DMA Channel #0 interrupt
